<div class="flex items-center mb-2 text-brand-400">
...
<div class="inline-flex items-center px-4 py-1 ml-6 font-semibold leading-5 border rounded-full bg-brand-50 border-brand-200/50">
    <span class="w-2 h-2 mr-2 rounded-full bg-brand-200"></span>
    <span class="text-sm text-brand-200 ">{{ session('order.date')->isoFormat('dddd, D MMMM G') }}</span>
    <div class="ml-2 text-brand-200">
