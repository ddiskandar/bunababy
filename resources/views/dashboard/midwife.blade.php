<x-app-layout>
    ...
    <div class="pb-6 md:flex md:justify-between md:items-center">
        <div class="text-xl font-semibold">Hai, {{ auth()->user()->name }}</div>
        <div>Hari {{ today()->isoFormat('dddd, D MMMM YYYY') }}</div>
    </div>
