<footer id="page-footer" class="flex flex-none items-center bg-white">
    <div class="text-center flex flex-col md:text-left md:flex-row md:justify-between text-sm max-w-10xl mx-auto px-4 lg:px-8 w-full">
        ...
        <a href="https://tailkit.com" target="_blank" class="font-medium text-indigo-600 hover:text-indigo-400">Bunababy</a>
        </div>
        ...
        <span>by <a href="#" target="_blank" class="font-medium text-indigo-600 hover:text-indigo-400">Dede Iskandar</a></span>
        </div>
    </div>
</footer>
