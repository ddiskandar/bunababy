            ...
            <div class="md:flex">
                ...
                <div class="md:w-2/3 md:pl-24">
                    <form class="space-y-6" onsubmit="return false;">
                        <div class="space-y-1">
                            <label class="font-medium" for="billing_company">Site Name</label>
                        ...
                        <div class="space-y-1">
                            <label class="font-medium" for="billing_address1">Site Location</label>
                        ...
                        <div class="space-y-1">
                            <label class="font-medium" for="billing_address2">Site Description</label>
                            <input class="block border placeholder-gray-400 px-3 py-2 leading-6 w-full rounded border-gray-200 focus:border-pink-500 focus:ring focus:ring-pink-500 focus:ring-opacity-50" type="text" id="billing_address2" name="billing_address2">
                        </div>
                        <div class="space-y-1">
                            <label class="font-medium" for="billing_address2">Instagram</label>
                            <input class="block border placeholder-gray-400 px-3 py-2 leading-6 w-full rounded border-gray-200 focus:border-pink-500 focus:ring focus:ring-pink-500 focus:ring-opacity-50" type="text" id="billing_address2" name="billing_address2">
                        </div>
