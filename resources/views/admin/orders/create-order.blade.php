                ...
                <div class="max-w-lg space-y-6 ">
                    ...
                    @if ($selectedClient)
                        <div class="space-y-1">
                            ...
                            <select wire:model="state.kecamatanId" wire:change="setSelectedKecamatan"
                                ...
                                type="text" id="state.kecamatanId">
                    ...
                    @if ($selectedKecamatan)
                        <div class="space-y-1">
                            ...
                            <x-input wire:model="state.date" class="w-full" type="date"
                    ...
                    @if (isset($state['date']))
                        <div class="inline-flex items-center">
                            <div class="flex items-center h-5 ">
                                <input type="checkbox" wire:model.lazy="showAllMidwives" name="showAllMidwives"
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="-mt-4 divide-y divide-brand-50">
                                @foreach ($data as $key => $value)
                                    <div wire:key="{{ $selectedMidwife->id . '-' . $state['date'] . '-' . $key }}"
                                        class="py-4">
                                                ...
                                                @if (\Carbon\Carbon::parse($state['date'] . $slot['time'])->gt(now()))
                                                    @php
                                                        ...
                                                        if (isset($state['startTime'])) {
                                                            $inRange = \Carbon\Carbon::parse($slot['time'])->isBetween(\Carbon\Carbon::parse($state['startTime']), \Carbon\Carbon::parse($state['startTime'])->addMinutes($state['addMinutes']));
                                                        }
                                                    ...
                                                    @if ($slot['status'] === 'empty')
                                                        <button
                                                            wire:key="{{ $selectedMidwife->id . '-' . $state['date'] . '-' . $slot['id'] }}"
