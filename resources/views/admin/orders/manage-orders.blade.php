            ...
            <div class="flex flex-col gap-2 mt-4 sm:mt-0 sm:flex-row sm:items-center sm:justify-end">
                <div class="flex items-center space-x-1">
                    <div class="w-32 mt-3 text-center sm:mt-0 sm:text-right">
                        <input wire:model="filterFromDate"
        ...
        <div class="w-full p-3 border-b border-gray-100 grow">
            <div class="relative">
                ...
                <input wire:model="filterSearch"
                    ...
                    type="search" placeholder="Mencari berdasarkan ID, nama client, atau alamat ..." />
            </div>
        </div>
        <!-- END Card Header -->
                ...
                <table class="min-w-full text-sm">
                    <thead>
                        <tr class="bg-slate-50">
                            <th scope="col"
                                class="p-3 pl-6 text-xs font-medium tracking-wider text-left uppercase text-slate-500">
                                ID / Waktu
                            </th>
                            <th scope="col"
                                class="p-3 text-xs font-medium tracking-wider text-left uppercase text-slate-500 md:table-cell">
                            ...
                            <th scope="col"
                                class="p-3 text-xs font-medium tracking-wider text-center uppercase text-slate-500">
                                Actions
                            </th>
                        </tr>
                    </thead>
                        ...
                        @forelse ($orders as $order)
                            <tr @class([
                                ...
                                <td class="p-3 pl-6 align-top whitespace-nowrap">
                                    ...
                                    <p class="font-semibold">{{ $order->getShortDate() }}</p>
                                    ...
                                    <td class="p-3 align-top whitespace-nowrap">
                                        ...
                                        @else
                                            <div class="flex items-center">
                                                ...
                                                <svg class="w-4 h-4 ml-1 text-green-600" fill="currentColor"
                                ...
                                <td class="p-3 align-top whitespace-nowrap">
                                    <span @class([
                                        ...
                                        'text-green-800 bg-green-100' =>
                                            $order->status === \App\Models\Order::STATUS_LOCKED,
                                        'text-blue-800 bg-blue-100' =>
                                            $order->status === \App\Models\Order::STATUS_FINISHED,
