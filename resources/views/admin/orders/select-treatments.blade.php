        ...
        <div class="max-w-lg space-y-6 md:w-2/3 md:pl-2">
            ...
            <form wire:submit.prevent="save">
                <div class="space-y-1">
                    ...
                    <select wire:model="state.treatmentId" class="w-full rounded-md border-brand-50 focus:border-brand-100 focus:ring-0 focus:ring-brand-100 focus:ring-opacity-50 disabled:bg-slate-100 disabled:opacity-75" type="text" id="state.treatmentId">
                ...
                <div class="mt-4 space-y-1">
                    ...
                    <select wire:model="state.familyId" wire:change="setSelectedFamily" class="w-full rounded-md border-brand-50 focus:border-brand-100 focus:ring-0 focus:ring-brand-100 focus:ring-opacity-50 disabled:bg-slate-100 disabled:opacity-75" type="text" id="state.familyId">
                        <option value="" selected>-- Pilih salah satu</option>
