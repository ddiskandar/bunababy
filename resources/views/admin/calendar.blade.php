...
<div class="flex flex-col rounded shadow-sm bg-white overflow-hidden">
    ...
    <div class="py-4 px-5 lg:px-6 w-full bg-gray-50 sm:flex sm:justify-between sm:items-center">
      ...
      <div class="mt-3 sm:mt-0 text-center sm:text-right">
        <input class="w-full block border border-gray-200 rounded px-3 py-2 leading-6 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="date" id="tk-form-elements-name" placeholder="Enter your name" />
      </div>
    </div>
    <!-- END Card Header -->
