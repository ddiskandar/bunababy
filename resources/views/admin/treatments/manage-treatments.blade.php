    ...
    <div class="flex flex-col overflow-hidden bg-white rounded shadow-sm">
        ...
        <div class="w-full py-3 pl-6 pr-3 bg-gray-50 sm:flex sm:justify-between sm:items-center">
            ...
            <div class="flex flex-col gap-2 mt-4 sm:mt-0 sm:flex-row sm:items-center sm:justify-end">
                ...
                <div class="flex items-center space-x-2 space-x-reverse sm:space-x-2">
                    <a href="{{ route('categories') }}" class="order-2 text-xs font-medium uppercase sm:order-1 text-slate-400 hover:text-brand-200 ">
                        Atur Kategori
                    </a>
                    <div class="order-1 w-40 sm:order-2">
                        <select wire:model="filterCategory" class="block w-full px-2 py-1 text-sm border border-gray-200 rounded focus:border-brand-100 focus:ring-0 ">
        ...
        <div class="w-full p-3 border-b border-gray-100 grow">
            <div class="relative">
                ...
                <input wire:model="filterSearch" class="block w-full py-1 pl-10 pr-3 text-sm leading-6 border border-gray-200 rounded focus:border-brand-100 focus:ring-0 focus:ring-brand-50" type="search" placeholder="Mencari berdasarkan nama, deskripsi, atau durasi ..." />
            </div>
        </div>
        <!-- END Card Header -->
                        ...
                        <tr @class([
                            ...
                            <td class="p-3 text-center align-top whitespace-nowrap">
                                <div class="flex justify-center space-x-2">
                                    <button wire:click="ShowEditTreatmentDialog({{ $treatment->id }})" class="text-slate-400 hover:text-brand-200">
                                        <x-icon-pencil/>
                                    </button>
                                </div>
                            </td>
        ...
        <form wire:submit.prevent="save">
            ...
            <div class="h-64 px-1 mt-2 space-y-3 overflow-y-auto">
                ...
                <div class="space-y-1">
                    ...
                    <select wire:model.lazy="state.category_id" class="w-full rounded-md border-brand-50 focus:border-brand-100 focus:ring-0 focus:ring-brand-100 focus:ring-opacity-50 disabled:bg-slate-100 disabled:opacity-75" type="text" id="state.category_id">
