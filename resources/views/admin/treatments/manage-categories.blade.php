    ...
    <div class="flex flex-col overflow-hidden bg-white rounded shadow-sm">
        ...
        <div class="w-full py-3 pl-6 pr-3 bg-white sm:flex sm:justify-between sm:items-center">
            ...
            <div class="flex flex-col gap-2 mt-4 sm:mt-0 sm:flex-row sm:items-center sm:justify-end">
                ...
                <a href="{{ route('treatments') }}" class="text-xs font-medium uppercase text-slate-400 hover:text-brand-200 ">
                    Atur Treatment
                </a>
                        ...
                        <tr @class([
                            ...
                            <td class="p-3 text-center align-top">
                                <div class="flex justify-center space-x-2">
                                    <button wire:click="ShowEditCategoryDialog({{ $category->id }})" class="text-slate-400 hover:text-brand-200">
