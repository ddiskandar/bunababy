                                            ...
                                            @if ($notification->data['type'] === 'order')
                                                ...
                                                <div class="md:flex md:items-center md:justify-between">
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <div
                                                            class="flex justify-center invisible space-x-2 group-hover:visible">
                                            ...
                                            @elseif ($notification->data['type'] === 'payment')
                                                <div class="flex justify-between">
                                                    <div>
                                                        ...
                                                        sebesar {{ $notification->data['payment_value'] }} untuk order
                                                        <a class="font-semibold text-brand-200"
                                                            href="{{ route('orders.show', $notification->data['order_id']) }}"
                                                            target="_blank">#{{ $notification->data['order_id'] }}</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="md:flex md:items-center md:justify-between">
                                                    ...
                                                    <div class="mt-4 mr-4 md:mt-0">
                                                        <a class="px-4 py-2 text-xs font-semibold text-white transition-all rounded-full bg-brand-200 hover:bg-brand-100"
                                                            href="/payments?filterSearch={{ $notification->data['order_id'] }}"
                                                            target="_blank">
                                            ...
                                            @elseif ($notification->data['type'] === 'unpaid')
                                                <div class="flex justify-between">
                                                    <div>
                                                        ...
                                                        untuk order <a class="font-semibold text-brand-200"
                                                            href="{{ route('orders.show', $notification->data['order_id']) }}"
                                                            target="_blank">#{{ $notification->data['order_id'] }}</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="md:flex md:items-center md:justify-between">
                                                    ...
                                                    <div class="mt-4 mr-4 md:mt-0">
                                                        <a class="px-4 py-2 text-xs font-semibold text-white transition-all rounded-full bg-brand-200 hover:bg-brand-100"
                                                            href="https://api.whatsapp.com/send?phone={{ $notification->data['order_client_phone'] }}&text=Halo+Buna+*{{ $notification->data['order_client_name'] }}*.%0aDP+untuk+order+{{ $notification->data['order_id'] }}+belum+dibayar+sampai+batas+waktu+{{ $notification->data['order_dp_timeout'] }}.%0a%0aMohon+konfirmasi+dan+segera+lakukan+pembayaran+agar+slot+order+Anda+kami+kunci.%0a%0aTerima+kasih.%0a%0aBunaBaby+Care"
                                                            target="_blank">
                                                            Kirim Pemberitahuan
                                                        </a>
                                                    </div>
                                            ...
                                            @elseif ($notification->data['type'] === 'orderDeleted')
                                                <div class="flex justify-between">
                                                    <div>
                                                        ...
                                                        dari {{ $notification->data['order_client_name'] }} untuk
                                                        tanggal {{ $notification->data['order_date'] }} dengan alasan
