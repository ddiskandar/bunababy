<x-action-section>
    ...
    <x-slot name="content">
        <div class="space-y-1">
            <div class="max-w-lg">
                <div class="relative z-0 space-y-2">
                    ...
                    <div class="relative px-4 w-full border border-gray-200 rounded-lg focus:z-10 focus:outline-none focus:border-blue-300 focus:ring focus:ring-blue-200 {{ $index > 0 ? 'border-t border-gray-200 rounded-t-none' : '' }} {{ ! $loop->last ? 'rounded-b-none' : '' }}">
        ...
        <x-secondary-button
            wire:click="showAddNewRoomDialog"
            class="mt-2 mr-2"
            type="button"
        >
