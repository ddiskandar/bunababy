    ...
    <x-slot name="content">
            ...
            <div class="flex flex-wrap gap-2 py-2">
                @forelse ($slots as $slot)
                    <div
                        ...
                        <button wire:click="delete({{ $slot->id }})" type="button"
                ...
                @empty
                    <div class="text-sm text-red-600">Belum ada slot waktu yang ditentukan</div>
                @endforelse
            </div>
        </div>
        ...
        <form wire:submit.prevent="add">
            <div class="mt-4 space-y-1">
                ...
                <div class="py-2 text-red-600">Pastikan pilih menit dalam interval 15 menit. misal 07:00 07:15 07:30
                    07:45</div>
                <x-input wire:model.defer="time" class="max-w-xl" type="time" id="time" />
