<x-app-layout>
    <div class="flex flex-col overflow-hidden bg-white rounded shadow-sm">
        <div class="flex items-center justify-between w-full px-5 py-4 lg:px-6 bg-gray-50">
          <div>
            <h3 class="font-semibold">
              Pelanggan
            </h3>
            <h4 class="text-sm text-gray-500">
              You have <span class="font-medium">260 Clients</span>
            </h4>
          </div>
        ...
        <div class="w-full p-5 border-b border-gray-100 lg:p-6 grow">
          ...
          <form onsubmit="return false;">
            ...
            <div class="relative">
              ...
              <input class="block w-full py-2 pl-10 pr-3 leading-6 border border-gray-200 rounded focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" type="text" id="search" name="search" placeholder="Search all contacts.." />
            </div>
          </form>
        </div>
