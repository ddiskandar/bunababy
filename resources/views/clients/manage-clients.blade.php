    ...
    <div class="flex flex-col overflow-hidden bg-white rounded shadow-sm">
        ...
        <div class="w-full p-3 border-b border-gray-100 grow">
            <div class="relative">
                ...
                <input wire:model="filterSearch" class="block w-full py-1 pl-10 pr-3 text-sm leading-6 border border-gray-200 rounded focus:border-bunababy-100 focus:ring-0 focus:ring-bunababy-50" type="text" placeholder="Mencari berdasarkan nama, wilayah, nomor WA atau IG ..." />
            </div>
        </div>
        <!-- END Card Header -->
                        ...
                        <tr @class([
                            ...
                            <td class="p-3 whitespace-nowrap">
                                <p class="flex items-center gap-2 ">
                                    ...
                                    <a href="https://api.whatsapp.com/send?phone={{ to_wa_indo($client->profile->phone) }}&text=Halo+Buna+{{ $client->name }}" target="_blank">
