                    ...
                    <div class="py-4 border-t border-brand-50">
                        ...
                        <div class="py-2">
                            <div class="flex space-x-0">
                                @for ( $i = 1; $i <= 5; $i++ )
                                    <div class="h-8 w-8 {{ $i <= $reservation->testimonial->rate ? 'text-yellow-500' : 'text-slate-400' }}">
                                        <svg class="w-15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
