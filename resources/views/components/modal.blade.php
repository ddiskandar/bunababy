...
>
    <div
        ...
        <div class="relative inline-block w-full text-left align-bottom transition-all transform sm:mb-8 sm:align-middle sm:max-w-lg sm:w-full"
            x-show="show"
            ...
            <div class="p-4 overflow-hidden bg-white rounded-lg shadow-xl sm:p-6 sm:pb-4">
                {{ $slot }}
            </div>
