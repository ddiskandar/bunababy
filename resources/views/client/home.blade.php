    ...
    <x-bottom-tabs>
            ...
            <x-section>
                @if (!$reservation || $reservation->getStatusString() === 'Selesai')
                    <a href="{{ route('order.create') }}">
                        <button
                            class="flex items-center justify-center w-full gap-3 px-8 py-1 mb-4 text-white transition duration-150 ease-in-out rounded-full bg-brand-200 hover:opacity-80 ">
                ...
                @endif
                <a href="https://api.whatsapp.com/send?phone={{ toWaIndo($phone) }}&text=Halo+Bunababy_Care.+Perkenalkan+saya+dengan+{{ auth()->user()->name ?? '' }} "
                    target="_blank">
                    <button
                        class="flex items-center justify-center w-full gap-3 px-8 py-1 text-white transition duration-150 ease-in-out bg-green-500 border-2 border-green-500 rounded-full hover:opacity-80 ">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" width="24" height="24"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <div class="px-6 py-4 mt-2 space-y-4 bg-white ">
            <div class="flex flex-col items-center">
                ...
                <p class="text-center">Jalan Cihanjuang Komplek Nata Endah Blok N No. 170 Cibabat, Kec. Cimahi Utara,
                    Kota Cimahi</p>
                <a href="https://www.instagram.com/bunababy_care" target="_blank"
                    class="inline-flex items-center px-6 py-1 mt-2 text-white bg-blue-600 rounded-full hover:opacity-80">
            ...
            <div class="flex flex-col items-center">
                ...
                <a href="https://www.instagram.com/bunababy_care" target="_blank"
                    class="inline-flex items-center px-6 py-1 text-white bg-purple-700 rounded-full hover:opacity-80">
