    ...
    <form wire:submit.prevent="save">
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                @foreach ($state['families'] as $index => $family)
                    ...
                    <div class="col-span-6 xl:col-span-2">
                        ...
                        <x-input wire:model.lazy="state.families.{{ $index }}.name" id="name"
                            class="block w-full mt-1 uppercase" type="text" name="name" />
                    ...
                    @if ($family['type'] !== 'Diri Sendiri')
                        ...
                        <div class="col-span-6 xl:col-span-2">
                            ...
                            <x-select wire:model.lazy="state.families.{{ $index }}.type" id="join_wa"
                                name="join_wa" autocomplete="join_wa" class="block w-full px-3 mt-1">
                    ...
                    <div class="col-span-6 xl:col-span-2">
                        ...
                        <x-input id="dob" wire:model.lazy="state.families.{{ $index }}.dob"
                            class="block w-full mt-1" type="date" name="dob" />
                ...
                <div class="col-span-6 lg:col-span-4">
                    ...
                    <x-input wire:model.lazy="state.address" id="address" class="block w-full mt-1" type="text"
                        name="address" placeholder="Nama jalan, Nomor Rumah, RT/RW" />
                ...
                <div class="col-span-6 lg:col-span-2">
                    ...
                    <x-input wire:model.lazy="state.desa" id="desa" class="block w-full mt-1" type="text"
                        name="desa" />
                ...
                <div class="col-span-6 lg:col-span-2">
                    ...
                    <x-input wire:model.lazy="state.kec" disabled id="kecamatan" class="block w-full mt-1"
                ...
                <div class="col-span-6 lg:col-span-2">
                    ...
                    <x-input wire:model.lazy="state.kab" disabled id="kab" class="block w-full mt-1"
                        type="text" name="kab" />
                </div>
                ...
                <div class="col-span-6 lg:col-span-3">
                    ...
                    <x-input wire:model.lazy="state.phone" id="kab" class="block w-full mt-1" type="text"
                        name="kab" />
                ...
                <div class="col-span-6 lg:col-span-3">
                    ...
                    <x-input wire:model.lazy="state.ig" id="kab" class="block w-full mt-1" type="text"
                        name="kab" />
        ...
        <div class="py-6">
            <div class="flex items-center mb-4 text-brand-400">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 icon icon-tabler icon-tabler-user-circle"
            ...
            <div class="mb-4 text-sm text-gray-500">Simpan dan catat akun login anda agar reservasi treatment
                kedepannya bisa lebih cepat.</div>
            <div class="grid grid-cols-6 gap-6">
                <!-- Alamat Email -->
                <div class="col-span-6 xl:col-span-4">
                    <x-label for="email" :value="__('Alamat Email')" />
                    <x-input wire:model.lazy="state.email" id="email" class="block w-full mt-1" type="email"
                        name="email" />
                ...
                <div class="col-span-6 xl:col-span-3">
                    ...
                    <x-input wire:model.lazy="state.password" id="password" class="block w-full mt-1"
            ...
            <div class="py-6">
                <button
                    class="flex items-center justify-center w-full text-center text-white transition duration-150 ease-in-out rounded-full shadow-xl h-14 disabled:opacity-25 bg-brand-200 shadow-brand-100/50"
