        ...
        @if (! auth()->check() && session()->missing('order.status'))
            <div class="px-2 space-y-2">
                <div class="flex flex-col items-center px-6 py-10 text-center bg-white rounded-lg shadow" >
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-gray-500" width="24" height="24" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="{{ route('order.check') }}" class="flex flex-col items-center px-6 py-10 text-white bg-green-500 rounded-lg shadow">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 " viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
