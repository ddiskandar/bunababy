<div>
    <div>
        ...
        <ul class="divide-y divide-brand-50">
            ...
            @empty
                <li class="flex flex-col items-center py-6">
                    <div>
                    ...
                    <div class="text-sm text-center text-slate-400">Belum ada yang diupload, tambahkan bukti upload
                    </div>
                </li>
            @endforelse
        </ul>
    ...
    @if (!$order->isPaid())
        ...
        @if (!$isLocked)
            <div class="py-4">
                <div>
                    <button wire:click="$set('showUploadDialog', true)" type="button"
                    ...
                    <x-dialog wire:model="showUploadDialog">
                        <form wire:submit.prevent="save">
                            ...
                            <div class="py-4 space-y-1">
                                ...
                                <x-input wire:model.defer="value" x-mask:dynamic="$money($input, ',')"
                                    class="w-full" type="text" id="value" />
                                <x-input-error for="value" class="mt-2" />
                            </div>

                            <div class="py-4">
                                <button
                                    class="flex items-center justify-center w-full transition duration-150 ease-in-out rounded-full shadow-xl h-14 disabled:opacity-25 bg-brand-200 shadow-brand-100/50"
                                    type="submit" wire:loading.attr="disabled" @disabled(!$value || !$attachment)>
