                ...
                <li class="relative border-b border-brand-50">
                    <button type="button" class="w-full px-6 py-4 text-left"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span :class="selected !== {{ $loop->iteration }} ? ' rotate-180' : ''"
                                class="transition-all duration-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 stroke-brand-200" width="24"
                            ...
                            <ul class="grid gap-4 xl:grid-cols-2">
                                ...
                                @foreach ($category['treatments'] as $treatment)
                                    <li class="p-6 border rounded border-slate-200">
                                        ...
                                        <div class="py-2 text-sm text-slate-400"><span
                                                class="font-medium text-slate-600">{{ rupiah($treatment['prices'][0]['amount']) }}</span>
                                            • <span class="font-medium text-slate-600">{{ $treatment['duration'] }}
                                                menit</span></div>
                                                    ...
                                                    @forelse ($pemesans as $key => $pemesan)
                                                        <div
                                                            ...
                                                            <button
                                                                ...
                                                                <svg class="inline-block w-4 h-4 hi-solid hi-x"
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <button
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="w-6 h-6 stroke-brand-200" fill="none"
            ...
            <div class="sm:flex sm:items-start">
                <div class="w-full">
                    ...
                    <div class="p-4 border rounded bg-brand-50/10 border-brand-50">
                        <div>
                            <h3 class="text-xl font-semibold leading-6" id="modal-title">
                                {{ $currentTreatment['name'] }}</h3>
                        </div>
                    </div>
