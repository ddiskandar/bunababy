<div>
    <div class="px-6 pt-4">
        ...
        <div class="flex flex-wrap gap-2 mt-3">
            <button wire:click="$set('filterCategory', '')" @class([
            ...
            @foreach ($categories as $category)
                <button wire:key="{{ $category->id }}" wire:click="$set('filterCategory', {{ $category->id }})"
                    @class([
                        'py-1 text-xs font-semibold px-4 border hover:bg-brand-200 hover:text-white transition-all border-brand-200 rounded-full',
    ...
    <div
        class="flex snap-x scroll-pl-4 space-x-4 overflow-x-auto p-4 sm:scroll-pl-6 sm:space-x-8 md:scroll-pl-[calc(50%-20rem)] lg:scroll-pl-[calc(50%-25rem)]">
