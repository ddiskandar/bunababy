<div>
    ...
    <button type="button" class="flex items-center justify-between w-full py-4 " wire:click="showModal">

        <div class="flex items-center ">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-brand-200" width="24" height="24"
    ...
    <x-dialog wire:model="showModalPicker">
        <div x-data x-intersect="$wire.load()">
            @guest
            ...
            <div class="py-3">
                <input wire:model="search" x-ref="input"
                    ...
                    type="text" id="tk-form-elements-name" autocomplete="off"
