            ...
            <nav class="space-y-1">
                ...
                @if (auth()->user()->isAdmin())
                    ...
                    <x-nav-link :href="route('notifications')" :active="request()->is('notifications*')">
                        <span class="flex items-center flex-none opacity-50">
                            <svg class="inline-block w-6 h-6 hi-outline hi-clipboard-list" fill="none"
                                viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5"
                    ...
                    <x-nav-link :href="route('calendar')" :active="request()->is('calendar*')">
                        <span class="flex items-center flex-none opacity-50">
                            <svg class="inline-block w-6 h-6 hi-outline hi-view-grid" fill="none"
                                viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5"
                    ...
                    <x-nav-link :href="route('clients')" :active="request()->is('clients*')">
                        <span class="flex items-center flex-none opacity-50">
                            <svg class="inline-block w-6 h-6 " fill="none" viewBox="0 0 24 24">
                                ...
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" d="M14.75 17.75L16 19.25L19.25 14.75"></path>
                            </svg>
                        </span>
                ...
                @if (auth()->user()->isOwner())
                    <div class="px-3 pt-5 pb-2 text-xs font-medium tracking-wider uppercase text-brand-300">SISTEM
                    </div>
                    ...
                    <x-nav-link :href="route('wilayah')" :active="request()->is('wilayah*')">
                        <span class="flex items-center flex-none opacity-50">
                            <svg class="inline-block w-6 h-6 " fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" d="M4.75 6.75L9.25 4.75V17.25L4.75 19.25V6.75Z"></path>
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" d="M14.75 6.75L19.25 4.75V17.25L14.75 19.25V6.75Z"></path>
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" d="M14.75 6.75L9.25 4.75V17.25L14.75 19.25V6.75Z"></path>
                            </svg>
                        </span>
                    ...
                    <x-nav-link :href="route('places')" :active="request()->is('places*')">
                        <span class="flex items-center flex-none opacity-50">
                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-6 h-6" width="24"
                    ...
                    <x-nav-link :href="route('settings')" :active="request()->is('settings*')">
                        <span class="flex items-center flex-none opacity-50">
                            <svg class="inline-block w-6 h-6 hi-outline hi-cog" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" d="M4.75 8H7.25"></path>
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" d="M12.75 8H19.25"></path>
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" d="M4.75 16H12.25"></path>
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" d="M17.75 16H19.25"></path>
                                <circle cx="10" cy="8" r="2.25" stroke="currentColor"
                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></circle>
                                <circle cx="15" cy="16" r="2.25" stroke="currentColor"
                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></circle>
                            </svg>
