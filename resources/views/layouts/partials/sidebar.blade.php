<nav
    ...
    <div class="overflow-y-auto scrollbar-bunababy">
        ...
        <nav class="space-y-1">
            ...
            <div class="px-3 pt-5 pb-2 text-xs font-medium tracking-wider uppercase text-bunababy-300">Order</div>
            ...
            <x-nav-link :href="route('admin.calendar')" :active="request()->routeIs('admin.calendar')">
                ...
                <span class="py-2 grow">Jadwal</span>
            </x-nav-link>
            ...
            <x-nav-link :href="route('admin.wilayah')" :active="request()->routeIs('admin.wilayah')">
                <span class="flex items-center flex-none opacity-50">
                    <svg class="inline-block w-6 h-6 " fill="none" viewBox="0 0 24 24">
            ...
            <a href="javascript:void(0)" class="flex items-center px-3 space-x-3 font-medium text-gray-600 rounded hover:text-gray-700 hover:bg-gray-100 active:bg-gray-50">
                <span class="flex items-center flex-none opacity-50">
                    <svg class="inline-block w-5 h-5 hi-outline hi-user" stroke="currentColor" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                </span>
                <span class="py-2 grow">Profile</span>
            </a>
            <a href="javascript:void(0)" class="flex items-center px-3 space-x-3 font-medium text-gray-600 rounded hover:text-gray-700 hover:bg-gray-100 active:bg-gray-50">
                <span class="flex items-center flex-none opacity-50">
                    <svg class="inline-block w-5 h-5 text-red-600 hi-outline hi-lock-open" stroke="currentColor" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z"/></svg>
                </span>
